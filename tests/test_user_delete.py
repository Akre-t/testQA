...
class TestUserDelete(BaseCase):
    ...
    def test_delete_admin_user(self):
        ...
        Assertions.assert_response_text(
            response2,
            "Удалять пользователей с ID 1,2,3,4,5 нельзя")
    ...
    def test_delete_just_created_user(self):
        ...
        Assertions.assert_response_text(response4,"Пользователь не найден")
    ...
    def test_edit_just_created_user_without_authorization(self):
        ...
        Assertions.assert_code_status(response2,400)
        Assertions.assert_response_text(response2,"Токен не предоставлен")
